...
xst -ifn xst.scr
move clk_64M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_64M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_64M_exdes.ucf clk_64M_exdes

echo 'Running map'
map -timing -pr b clk_64M_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_64M_exdes -w routed.ncd routed.vhd
cd ..
